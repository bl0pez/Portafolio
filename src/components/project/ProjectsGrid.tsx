  ...
  return (
    <>
      ...
      >
        ...
        <button onClick={() => setStack(Stack.Frontend)} className="btn">
          Frontend
        </button>
        <button onClick={() => setStack(Stack.Backend)} className="btn">
          Backend
        </button>
      </Animation>

      <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-4 pb-10">
